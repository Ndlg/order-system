...
class WaybillMode(WorkspaceModel):
    __tablename__ = "waybill_modes"
    __table_args__ = (UniqueConstraint("workspace_id", "code", name="uk_waybill_mode_workspace_code"),)
...
class WaybillTemplate(WorkspaceModel):
...
class WaybillTemplateField(WorkspaceModel):
